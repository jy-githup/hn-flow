  ...
  >
    ...
    <div class="head">
      <template v-if="session?.value">
        <div class="avatar">
          <cl-avatar :size="30" :src="session?.value.avatar" shape="square" />
        </div>
    ...
    <el-scrollbar class="list">
      <ul>
        <li v-for="(item, index) in list" :key="index">
          ...
          >
            <div class="avatar">
              <cl-avatar :size="36" :src="item.avatar" shape="square" />
            </div>
    ...
    <div class="footer">
      ...
      <div class="input">
        <el-input
          ...
          type="textarea"
        />
        <el-button :disabled="!value" type="success" @click="onTextSend">
          发送
        </el-button>
      </div>
    </div>
